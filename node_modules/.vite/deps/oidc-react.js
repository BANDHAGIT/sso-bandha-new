...
import {
  init_jwt_decode_esm,
  jwt_decode_esm_exports,
  require_core,
  require_enc_base64,
  require_enc_utf8,
  require_sha256
} from "./chunk-GBHBHR5B.js";
import {
  __commonJS,
  __toCommonJS
...
var require_oidc_client_ts = __commonJS({
  "node_modules/oidc-client-ts/dist/umd/oidc-client-ts.js"(exports, module) {
    ...
    var import_jwt_decode = __toESM((init_jwt_decode_esm(), __toCommonJS(jwt_decode_esm_exports)));
    var JwtUtils = class {
...
// node_modules/oidc-react/build/src/auth-context.js
var require_auth_context = __commonJS({
  "node_modules/oidc-react/build/src/auth-context.js"(exports) {
    "use strict";
    ...
    var oidc_client_ts_1 = require_oidc_client_ts();
    exports.AuthContext = react_1.default.createContext(void 0);
    var hasCodeInUrl = function(location) {
      var searchParams = new URLSearchParams(location.search);
      var hashParams = new URLSearchParams(location.hash.replace("#", "?"));
      return searchParams.has("code") || searchParams.has("id_token") || searchParams.has("session_state") || hashParams.has("code") || hashParams.has("id_token") || hashParams.has("session_state");
    };
    ...
    var AuthProvider = function(_a) {
      ...
      var signInPopupHooks = (0, react_1.useCallback)(function() {
        return __awaiter(void 0, void 0, void 0, function() {
          ...
          return __generator(this, function(_a2) {
            switch (_a2.label) {
              case 0:
                return [4, userManager.signinPopup()];
              case 1:
                userFromPopup = _a2.sent();
                setUserData(userFromPopup);
                if (!onSignIn) return [3, 3];
                return [4, onSignIn(userFromPopup)];
              case 2:
                _a2.sent();
                _a2.label = 3;
              case 3:
          ...
          return __awaiter(void 0, void 0, void 0, function() {
            ...
            return __generator(this, function(_a2) {
              switch (_a2.label) {
                ...
                case 1:
                  user = _a2.sent();
                  if (!(isMounted && (!user || user.expired))) return [3, 11];
                  if (!(0, exports.hasCodeInUrl)(location)) return [3, 8];
                  _a2.label = 2;
                case 2:
                  _a2.trys.push([2, 6, , 7]);
                ...
                case 3:
                  user_1 = _a2.sent();
                  if (!user_1) return [3, 5];
                  setUserData(user_1);
                  if (!onSignIn) return [3, 5];
                  return [4, onSignIn(user_1)];
                case 4:
                  _a2.sent();
                  _a2.label = 5;
                case 5:
                ...
                case 7:
                  return [3, 10];
                case 8:
                  if (!autoSignIn) return [3, 10];
                  state = onBeforeSignIn ? onBeforeSignIn() : void 0;
                  return [4, userManager.signinRedirect(__assign(__assign({}, autoSignInArgs), { state }))];
                case 9:
                  _a2.sent();
                  _a2.label = 10;
                case 10:
      ...
      (0, react_1.useEffect)(function() {
        ...
        var onSilentRenewError = function() {
          return __awaiter(void 0, void 0, void 0, function() {
            return __generator(this, function(_a2) {
              switch (_a2.label) {
                case 0:
                  if (!autoSignOut) return [3, 3];
                  return [4, signOutHooks()];
                case 1:
                  _a2.sent();
                  return [4, userManager.signoutRedirect(autoSignOutArgs)];
                case 2:
                  _a2.sent();
                  _a2.label = 3;
                case 3:
          ...
          signIn: function(args) {
            return __awaiter(void 0, void 0, void 0, function() {
              return __generator(this, function(_a2) {
                switch (_a2.label) {
                  case 0:
                    return [4, userManager.signinRedirect(args)];
                  case 1:
                    _a2.sent();
                    return [
                      2
          ...
          signOut: function() {
            return __awaiter(void 0, void 0, void 0, function() {
              return __generator(this, function(_a2) {
                switch (_a2.label) {
                  case 0:
                    return [4, userManager.removeUser()];
                  case 1:
                    _a2.sent();
                    return [4, signOutHooks()];
                  case 2:
          ...
          signOutRedirect: function(args) {
            return __awaiter(void 0, void 0, void 0, function() {
              return __generator(this, function(_a2) {
                switch (_a2.label) {
                  case 0:
                    return [4, userManager.signoutRedirect(args)];
                  case 1:
                    _a2.sent();
                    return [4, signOutHooks()];
                  case 2:
      ...
      return react_1.default.createElement(exports.AuthContext.Provider, { value }, children);
    };
    exports.AuthProvider = AuthProvider;
  }
});

// node_modules/oidc-react/build/src/use-auth.js
var require_use_auth = __commonJS({
  "node_modules/oidc-react/build/src/use-auth.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.useAuth = void 0;
    var react_1 = require_react();
    var auth_context_1 = require_auth_context();
...
// node_modules/oidc-react/build/src/with-auth.js
var require_with_auth = __commonJS({
  "node_modules/oidc-react/build/src/with-auth.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var use_auth_1 = require_use_auth();
...
// node_modules/oidc-react/build/src/auth-context-interface.js
var require_auth_context_interface = __commonJS({
  "node_modules/oidc-react/build/src/auth-context-interface.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
  }
});

// node_modules/oidc-react/build/src/index.js
var require_src = __commonJS({
  "node_modules/oidc-react/build/src/index.js"(exports) {
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
      if (!desc || ("get" in desc ? !m.__esModule : desc.writable || desc.configurable)) {
    ...
    __exportStar(require_use_auth(), exports);
    __exportStar(require_with_auth(), exports);
    __exportStar(require_auth_context(), exports);
    __exportStar(require_auth_context_interface(), exports);
    var oidc_client_ts_1 = require_oidc_client_ts();
    Object.defineProperty(exports, "User", { enumerable: true, get: function() {
      return oidc_client_ts_1.User;
    } });
    Object.defineProperty(exports, "UserManager", { enumerable: true, get: function() {
      return oidc_client_ts_1.UserManager;
    } });
    Object.defineProperty(exports, "Log", { enumerable: true, get: function() {
      return oidc_client_ts_1.Log;
    } });
    Object.defineProperty(exports, "WebStorageStateStore", { enumerable: true, get: function() {
      return oidc_client_ts_1.WebStorageStateStore;
    } });
  }
});
